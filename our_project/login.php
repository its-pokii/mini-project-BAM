...
<body class="font-['Roboto'] box-border m-0 p-0 font-[Inter,sans-serif] bg-[#f8fafc] text-[#1a202c] min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex justify-center items-center p-5">
            ...
            <form>
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" placeholder="your.email@uca.ac.ma" required
                ...
                <div class="text-right mb-6">
                    <a href="#" class="text-xs text-[#228cef] hover:text-blue-300 no-underline font-semibold">Forgot password?</a>
                </div>
